...
import com.rova.g3an.interfaces.OnItemClick;
import com.rova.g3an.models.CartItem;
...
public class CartItemAdapter extends RecyclerView.Adapter<CartItemAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final CartItemAdapter.ViewHolder Viewholder, final int position) {
        ...
        Glide.with(context)
                ...
                .placeholder(R.drawable.ic_good) // any placeholder to load at start
                .error(R.drawable.ic_good)  // any image in case of error
